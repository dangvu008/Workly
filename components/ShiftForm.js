  ...
  const validateForm = useCallback(() => {
    ...
    if (!name.trim()) {
      ...
      const isDuplicate = shifts.some(
        (shift) =>
          shift.name.toLowerCase().trim() === name.toLowerCase().trim() &&
          shift.id !== shiftId
      );
      if (isDuplicate) {
    ...
    if (officeEndTime && endTime) {
      ...
      if (endMinutes >= officeEndMinutes) {
        ...
        isEndAfterOfficeEnd =
          isOvernightShift && isEndNextDay && endMinutes >= officeEndMinutes;
      }
        ...
        <View style={styles.formContainer}>
            ...
            <View style={styles.selectContainer}>
              {[5, 10, 15, 30, 60].map((minutes) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.selectOption,
                    remindBeforeStart === minutes.toString()
            ...
            <View style={styles.selectContainer}>
              {[5, 10, 15, 30, 60].map((minutes) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.selectOption,
                    remindAfterEnd === minutes.toString()
                      ? styles.selectOptionActive
                      : null,
                  ]}
          ...
          <View style={styles.formGroup}>
            <View style={styles.switchRow}>
              ...
              <TouchableOpacity
                style={[styles.switch, showPunch ? styles.switchActive : null]}
