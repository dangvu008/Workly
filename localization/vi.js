...
export default {
  ...
  home: {
    ...
    workingTime: "Đã đi làm {duration}",
  ...
  notes: {
    ...
    validation: {
      ...
      contentTooLong: "Nội dung không được vượt quá 300 ký tự",
      reminderTimeRequired: "Thời gian nhắc nhở là bắt buộc",
      reminderDaysRequired: "Cần chọn ít nhất một ngày nhắc nhở",
      duplicateNote: "Đã tồn tại một ghi chú với tiêu đề và nội dung này",
    },
  },
  backup: {
